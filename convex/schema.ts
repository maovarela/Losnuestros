...
export default defineSchema({
  ...
  settlements: defineTable({
    patient_id: v.id("patients"),
    to_id: v.id("caregivers"),
    to_name: v.string(),
    amount: v.number(),
    month_key: v.string(),
    at: v.number(),
    updated_by: v.id("caregivers"),
    updated_by_name: v.string(),
    note: v.optional(v.string()),
  })
    .index("by_patient", ["patient_id"])
    .index("by_patient_to", ["patient_id", "to_id"]),
});
